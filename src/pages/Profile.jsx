...
const Profile = () => {
  ...
  // ======= Cargar usuario - CORREGIDO CON STORAGE LISTENER =======
  useEffect(() => {
    const loadUser = () => {
    ...
    // Escuchar cambios en localStorage (cuando otro tab/window cambia el user)
    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#030712", fontFamily: "Segoe UI, sans-serif", display: "flex", justifyContent: "center", padding: "80px 1rem 40px" }}>
      <div style={{ display: "flex", gap: "1rem", maxWidth: "980px", width: "100%", padding: "0 0.5rem", flexWrap: "wrap" }}>
        ...
        <div style={{ flex: "0 0 260px", backgroundColor: "#111827", borderRadius: "12px", padding: "1.1rem 0.95rem", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", boxShadow: "0 4px 12px rgba(0,0,0,0.3)", position: "relative", overflow: "hidden", width: "100%", maxWidth: "360px" }}>
          ...
          {!isEditing ? (
            <button onClick={handleEditClick} title="Editar" style={{ position: "absolute", top: "10px", right: "10px", height: "32px", padding: "0 12px", borderRadius: "10px", backgroundColor: "#334155", color: "#FFF", border: "1px solid rgba(148,163,184,0.15)", cursor: "pointer", display: "flex", alignItems: "center", gap: "8px", fontWeight: 800, fontSize: "0.78rem" }}>
              <FaEdit size={12} /> Editar
            </button>
          ) : (
            <button onClick={handleSaveClick} title="Guardar" style={{ position: "absolute", top: "10px", right: "10px", height: "32px", padding: "0 12px", borderRadius: "10px", backgroundColor: "#22C55E", color: "#000", border: "1px solid rgba(34,197,94,0.35)", cursor: "pointer", display: "flex", alignItems: "center", gap: "8px", fontWeight: 900, fontSize: "0.78rem" }}>
          ...
          <div style={{ position: "relative", marginTop: "6px", marginBottom: "0.75rem" }}>
            ...
            <button onClick={() => setShowAvatarMenu((v) => !v)} title="Opciones de foto" style={{ position: "absolute", right: "-6px", bottom: "-6px", width: "28px", height: "28px", borderRadius: "10px", backgroundColor: "#111827", border: "1px solid rgba(255,193,7,0.35)", color: "#FFC107", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <FaCamera size={12} />
            </button>
            {showAvatarMenu && (
              <div style={{ position: "absolute", top: "62px", right: "-8px", width: "160px", backgroundColor: "#0B1220", border: "1px solid rgba(148,163,184,0.18)", borderRadius: "12px", boxShadow: "0 10px 22px rgba(0,0,0,0.45)", padding: "8px", zIndex: 20 }}>
                <button onClick={openFilePicker} style={{ width: "100%", border: "none", background: "transparent", color: "#E5E7EB", padding: "8px 10px", borderRadius: "10px", cursor: "pointer", display: "flex", alignItems: "center", gap: "10px", fontSize: "0.82rem" }}>
                  <FaCamera color="#FFC107" /> Subir foto
                </button>
                <button onClick={removeAvatar} style={{ width: "100%", border: "none", background: "transparent", color: "#E5E7EB", padding: "8px 10px", borderRadius: "10px", cursor: "pointer", display: "flex", alignItems: "center", gap: "10px", fontSize: "0.82rem" }}>
                  <FaTrash color="#94A3B8" /> Quitar foto
                </button>
              </div>
            )}
          ...
          <div style={{ width: "100%", display: "flex", flexDirection: "column", gap: "1.05rem" }}>
            <div style={{ textAlign: "left", width: "100%" }}>
              <h3 style={{ color: "#FFC107", fontSize: "0.92rem", fontWeight: 800, display: "flex", alignItems: "center", gap: "6px", margin: "0 0 0.6rem 0" }}>
            ...
            <div style={list3Items}>
              {filteredReturns.map((ret) => (
                <div key={ret.id} onClick={() => handleReturnDetailsOpen(ret)} style={{ ...cardOnlyBorder, cursor: "pointer" }}>
                  <button onClick={(e) => { e.stopPropagation(); openImage(ret.image); }} title="Ver imagen" style={{ width: "44px", height: "44px", borderRadius: "12px", overflow: "hidden", border: "1px solid rgba(255,255,255,0.14)", background: "transparent", padding: 0, cursor: "pointer", flex: "0 0 44px" }}>
                    <img src={ret.image} alt={ret.productName} style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
                  </button>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <p style={{ color: "#f8fafc", fontWeight: 700, marginBottom: "0.25rem", fontSize: "0.9rem" }}>
                      {ret.productName} <span style={{ color: "#94a3b8", fontWeight: 600 }}>· Talla {ret.size}</span>
                    </p>
                    <div style={{ display: "flex", gap: "0.6rem", flexWrap: "wrap" }}>
                      <span style={{ color: "#94a3b8", fontSize: "0.78rem" }}>{ret.id} · Pedido {ret.orderId}</span>
                      <span style={{ color: "#94a3b8", fontSize: "0.78rem" }}>{ret.date}</span>
                    </div>
                    <p style={{ color: "#94a3b8", fontSize: "0.78rem", marginTop: "0.35rem" }}>{ret.reason}</p>
                  </div>
